...
// // import { CreateProductFetching } from "./actions"; // Import your server action

// // Categories for select
// const categories = ["Electronics", "Clothing", "Home & Garden", "Sports", "Toys", "Books", "Other"];

// const ProductForm: React.FC = () => {
//    const [state, formAction, isPending] = useActionState<{ success?: boolean; message?: string } | null, FormData>(CreateProductFetching, null);
...
//                                  <Tag className="w-4 h-4" /> Name <span className="text-red-500">*</span>
//                               </Label>
//                               <Input id="name" name="name" placeholder="e.g. Wireless Headphones" defaultValue="" className="focus-visible:ring-indigo-500" required />
//                            </div>

//                            {/* SKU */}
//                            <div className="space-y-2">
//                               <Label htmlFor="sku" className="text-sm font-medium flex items-center gap-1">
//                                  <Hash className="w-4 h-4" /> SKU <span className="text-red-500">*</span>
//                               </Label>
//                               <Input id="sku" name="sku" placeholder="e.g. WH-1000XM4" defaultValue="" className="focus-visible:ring-indigo-500" required />
//                            </div>
...
//                                  <Input id="price" name="price" type="number" step="0.01" min="0" placeholder="0.00" className="pl-9 focus-visible:ring-indigo-500" required />
//                               </div>
//                            </div>
...
//                                  <Package className="w-4 h-4" /> Stock <span className="text-red-500">*</span>
//                               </Label>
//                               <Input id="stock" name="stock" type="number" min="0" step="1" placeholder="0" className="focus-visible:ring-indigo-500" required />
//                            </div>
...
//                               <AlertDescription>{state.message || "Failed to create product. Please try again."}</AlertDescription>
//                            </Alert>
//                         )}
...
//       body: formData,
//    });
//    console.log(res, "my response in server");
//    console.log(prevState, "my prev state");
...
//          if (picture && picture.size > 1 * 1024 * 1024) {
//             // Show error immediately without calling Server Action
//             return {
//                picture: ["Image must be less than 1MB for server processing"],
//             };
//          }
//          return {
//             success: false,
...
//                               </Label>
//                               <Input id="name" name="name" placeholder="e.g. Wireless Headphones" defaultValue="" className="focus-visible:ring-indigo-500" />
//                               {state?.errors?.name && <p className="text-sm text-red-600">{typeof state.errors.name === "string" ? state.errors.name : state.errors.name[0]}</p>}
//                            </div>
                     ...
                     <form action={formAction} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                           ...
                           <div className="space-y-2">
                              ...
                              <Input id="name" name="name" placeholder="e.g. Wireless Headphones" defaultValue={state?.formData?.name || ""} className="focus-visible:ring-indigo-500" />
                           ...
                           <div className="space-y-2">
                              ...
                              <Input id="brand" name="brand" placeholder="e.g. Sony" defaultValue={state?.formData?.brand || ""} className="focus-visible:ring-indigo-500" />
                           ...
                           <div className="space-y-2">
                              ...
                              <div className="relative">
                                 <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" />
                                 <Input id="price" name="price" type="number" step="0.01" min="0" placeholder="0.00" defaultValue={state?.formData?.price || ""} className="pl-9 focus-visible:ring-indigo-500" />
                              </div>
                           ...
                           <div className="space-y-2">
                              ...
                              <Input id="stock" name="stock" type="number" min="0" step="1" placeholder="0" defaultValue={state?.formData?.stock || ""} className="focus-visible:ring-indigo-500" />
                           ...
                           <div className="space-y-2">
                              ...
                              <Input id="note" name="note" placeholder="Any additional notes" defaultValue={state?.formData?.note || ""} className="focus-visible:ring-indigo-500" />
                           </div>
                        </div>
                        ...
                        <div className="space-y-2">
                           ...
                           <Textarea id="description" name="description" placeholder="Detailed product description..." rows={4} defaultValue={state?.formData?.description || ""} className="focus-visible:ring-indigo-500 resize-none" />
